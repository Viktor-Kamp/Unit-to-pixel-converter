...
Tip: Since Blender 4.5, it is possible to set the pixel Density (PPI) to the metadata of certain Image-File-Formats. Using this eliminates the need to change the PPI to the right density inside image editing software. You can find this panel at: "Properties > Output > Output > Pixel Density"
